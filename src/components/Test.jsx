...
export default function Test() {
     const ipAdress= '127.0.0.1' 
      ...
      const associer = async () => {
        ...
        const tablette = {
          "device_id": "SP1A.210812.016.N970U1UES8HWG1",
        };
        const local={
          "num_local": "5",
          "type_local": "salle"
        ...
        try {
            ...
            const send = async()=>{
              ...
              try{
                let response = await axios.post(`http://${ipAdress}:8000/api/departement/create`, departement, {
                  headers: {
                      'Content-Type': 'application/json'
                  },
  ...
  return (
    <div>
      <button onClick={associer}>test1</button><br/>
      <button onClick={pas}>test2</button><br/>
      <button onClick={send}>test3</button><br/>
    </div>
  )
}
