            ...
            <div role="tablist" className="tabs tabs-lifted">
                ...
                >
                    <div className="overflow-x-auto">
                        <div className="items-center">
                            <div>
                                <h1 className="text-xl text-center mb-4 mr-10">Etudiants Présents</h1>
                            </div>

                            <div className="flex flex-row">
                                <div className="card w-96 bg-base-100 shadow-xl mb-4 mr-40">
                                ...
                                <div className="w-full max-w-xs">
                                    <select
                                        className="mx-auto select select-bordered w-full"
                                        value={local}
                            ...
                            <div className="flex">
                                <label className="m-auto input w-1/4 input-bordered flex items-center gap-2">
                ...
                >
                    <div className="overflow-x-auto">
                        <div className="items-center">
                            <div>
                                <h1 className="text-xl text-center mb-4 mr-10">Etudiants Absents</h1>
                            </div>
                            <div className="flex flex-row">
                                <div className="card w-96 bg-base-100 shadow-xl mb-4 mr-40">
                                    <div className="card-body">
